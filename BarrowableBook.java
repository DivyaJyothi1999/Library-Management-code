...
/*
 * This class is for barrowable books which extends the read-only book for similar properties.
 */
public class BarrowableBook extends ReadBookAtLibrary {

	// creating field members for dates
	private String checkOutDate, dueDate;

/*This method overrides the super class method and push the book info to the. sub_stack. After that the sub_stack is pushed into the main stack. */
	@Override
	public void Add() {
	...
	/*This method helps to initialize members to empty to avoid null-pointer exception*/
	public void initial() {
		this.checkOutDate = "";
		this.dueDate = "";
	}
